 ...
 */
package org.ymgy.transwins.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new org.ymgy.transwins.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new org.ymgy.transwins.modules.sys.entity.User(null, userId)))){
